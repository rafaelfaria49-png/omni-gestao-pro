...
export async function upsertVendaInTransaction(
  ...
  // Quando o sync foi retroativo (sessão original fechada, autorizado explicitamente),
  // carimba metadados de auditoria — nunca enviados pelo cliente, calculados aqui no
