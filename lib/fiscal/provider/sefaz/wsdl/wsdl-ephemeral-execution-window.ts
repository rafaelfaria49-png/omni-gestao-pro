 ...
 *
 * Estado atual (GOAL 020 · 147 · CONTAINMENT OFF da janela de diagnóstico browser-assisted
 * sincronizado): **DORMENTE** — `activationId`, `notBeforeUtc` e `expiresAtUtc` restaurados a
 * `null`. A janela `wsdl-h9h10-20260902-1400z-4b5f2504640de6e4` (02/09 14:00→14:10Z / 11:00→11:10
 * BRT) **EXPIROU SEM CONSUMO**: a invocation administrativa NÃO foi realizada e nenhum GET WSDL
 ...
 * executável e jamais deve ser re-materializada sem NOVA autorização humana. As activations de
 * 30/08, 31/08 e a de 02/09 04:30z (`772103b09d9477ca`) seguem históricas/proibidas. Gate 2
