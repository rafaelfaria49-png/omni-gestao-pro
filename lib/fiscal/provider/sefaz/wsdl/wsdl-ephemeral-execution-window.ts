 ...
 *
 * Estado atual (GOAL 020 · 146 · DIAGNÓSTICO H-9/H-10 browser-assisted sincronizado,
 * autorização textual humana verbatim vigente e NÃO consumida): **ATIVA** —
 * `wsdl-h9h10-20260902-1400z-4b5f2504640de6e4`, janela única de 10 minutos
 * (14:00:00Z → 14:10:00Z de 02/09, folga operacional para checks/merge/deploy ON READY
 * antes de `notBeforeUtc`; invocation só se restarem ≥ 8 min até `expiresAtUtc`). Uma única
 ...
 * após qualquer resultado restaurará `{null, null, null}`. As activations de 30/08, 31/08 e a
 * de 02/09 04:30z (`772103b09d9477ca`, expirada sem consumo) são históricas/proibidas e jamais
