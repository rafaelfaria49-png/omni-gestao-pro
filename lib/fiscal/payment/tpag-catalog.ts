...
export const TPAG_CATALOGO_OFICIAL: readonly TPagCatalogoEntry[] = [
  ...
  { tPag: "17", descricao: "Pagamento Instantâneo (PIX) – Dinâmico" },
  ...
  { tPag: "20", descricao: "Pagamento Instantâneo (PIX) – Estático" },
  { tPag: "21", descricao: "Crédito em Loja" },
  { tPag: "22", descricao: "Pagamento Eletrônico Não Informado" },
  { tPag: "23", descricao: "Pagamento Instantâneo (PIX) – Automático" },
