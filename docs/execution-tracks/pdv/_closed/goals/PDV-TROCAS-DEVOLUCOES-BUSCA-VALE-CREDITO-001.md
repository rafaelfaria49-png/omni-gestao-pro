<!-- AEP:META
{
  ...
  "worktree": "<PREENCHER>",
  "test_command": "npx vitest run app/api/vendas/historico/route.test.ts app/api/ops/devolucao/route.test.ts app/api/ops/credito-cliente/route.test.ts lib/ops-upsert-venda-vale-concorrencia.test.ts lib/ops-upsert-venda-vale.test.ts lib/ops-upsert-venda.test.ts lib/ops-upsert-venda-safety.test.ts lib/ops-upsert-venda-fiscal-handoff.test.ts app/api/vendas/[id]/cancelar/route.test.ts lib/pdv-payments.test.ts lib/caixa-fechamento-resumo.test.ts",
  "allowlist": [
    "app/api/vendas/**",
    ...
    "lib/ops-upsert-venda-fiscal-handoff.test.ts",
