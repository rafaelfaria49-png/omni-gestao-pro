...
{
  "aep": "1.0-R2",
  "id": "CONTADOR-HUB-IDENTIDADE-CONVITE-014",
  "track": "contador",
  "title": "Identidade externa, vínculo e convite do contador",
  "status": "DONE",
  "class": "C2",
  "risk_tier": "ALTO",
  "branch": "origin/main",
  ...
  "gate_humano": {
    ...
    "aprovacao": {
      "aprovado": true,
      "autorizacao": "AUTORIZO O PUSH FAST-FORWARD DO GOAL 014 E SUA RECONCILIACAO AEP PARA ORIGIN/MAIN",
      "registrado_por": "humano na sessao Kimi K3 (chat)",
      "em": "2026-08-01T08:45:00Z"
    }
  }
}
-->

# CONTADOR-HUB-IDENTIDADE-CONVITE-014 — Identidade externa, vínculo e convite do contador
...
- importado de `CONTADOR-HUB-FABLE5-MASTERPLAN-001` em 2026-08-01T11:54:56.745Z
- commit confirmado: `858c1289116527fe0ac2d28bdc5d75e671e2a6f0` na branch `origin/main`
