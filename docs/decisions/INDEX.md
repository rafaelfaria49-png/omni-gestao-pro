...
| 0023 | Contrato canônico de pagamento fiscal da NFC-e (fail-closed; XML não interpreta `paymentBreakdown`) | cross / fiscal | ✅ Aceita | 2026-08-19 | [`ADR-0023-pagamento-fiscal-canonico-nfce-fail-closed.md`](./ADR-0023-pagamento-fiscal-canonico-nfce-fail-closed.md) |
